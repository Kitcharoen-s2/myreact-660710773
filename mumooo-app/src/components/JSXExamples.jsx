...
function JSXExamples(){
    ...
    const user ={
        ...
        lastName: "กิจเจริญ",
        age: 20,
        hobbies:['เล่นเกม','ฟังเพลง','ดูหนัง']
    }
        ...
        <div className = "jsx-examples">
           <h1>JSX Example</h1>
            ...
            <section>
                ...
                {greeting}
                <p>สวัสดีค่ะคุณ {name} อายุ {age} ปี</p>
            ...
            <section>
             ...
             <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'ข้าวไก่ผัดพริกเผา', price: 40, inStock: true },
                        { id: 2, name: 'ข้าวกะเพราหมูสับไข่ดาว', price: 50, inStock: true },
                        { id: 3, name: 'ผัดไทห่อไข่กุ้งสด', price: 65, inStock: false }
                    ].map(product => (
